...
import com.example.hospital.model.MyToast;
import com.example.hospital.network.JsonPost;

import java.util.HashMap;


public class RegisterActivity extends HospitalBarActivity {
    ...
    public class UserRegisterTask extends AsyncTask<Void, Void, Integer> {
        ...
        protected Integer doInBackground(Void... params) {
            ...
            try {
                ...
                String url = "http://172.31.131.20/api/registerandroid/";
                ...
                new JsonPost(map, url, "register");
                Thread.sleep(1000);
            } catch (MyException.registerfailException e) {
                rettype = 1;
            } catch (Exception e) {
                rettype = 2;
            }
