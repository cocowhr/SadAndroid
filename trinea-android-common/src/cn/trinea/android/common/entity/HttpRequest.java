...
public class HttpRequest {
    ...
    private String              url,postPairs,postUrl,rawUrl;
    ...
    public HttpRequest(String postUrl, String postPairs) {
    	this(postUrl + postPairs);
    ...
    public String getPostPairs() {
        return postPairs;
    }
    /**
     * 为了post初始化
     * 2015-03-25
     * @param url http://www.aibaiche.com/api/client/do.php
     */
